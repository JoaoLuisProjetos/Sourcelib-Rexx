      CBL CICS('LINKAGE')
      CBL CICS('SP,COBOL2,APOST,DEBUG')
      CBL CICS('NOOPT,LANGLVL(2)'),LIB,NODYNAM,SIZE(8000K)
      ******************************************************************
      ...
      * NUMERO DA PORTA NO UNISYS
           05  SERVER-PORT                PIC 9(4) BINARY VALUE 08811.
      ...
      *=============================================*
       ...
       050-00-PROCEDIMENTOS-INICIAIS.
            DISPLAY '*** ENTRANDO NO STUB XXXS99 CICS ***'.
            EXEC CICS GET CONTAINER(XXXS99-CONTAINER OF XXXS99-CHANNELS)
                 CHANNEL           (XXXS99-CHANNEL OF XXXS99-CHANNELS)
                          INTO     (XS9901-XXXS99)
            END-EXEC.
      *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
     ...
     ***   GOBACK.
           ...
           EXEC CICS PUT CONTAINER(XXXS99-CONTAINER OF XXXS99-CHANNELS)
                CHANNEL           (XXXS99-CHANNEL OF XXXS99-CHANNELS)
                              FROM(XS9901-XXXS99)
                           FLENGTH(LENGTH OF XS9901-XXXS99)
           END-EXEC.
           DISPLAY '*** SAINDO DO STUB XXXS99 CICS ***'.
